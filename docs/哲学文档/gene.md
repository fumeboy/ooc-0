...
<!--
@referenced-by src/types/object.ts — implemented-by — StoneData, Talkable, Thinkable, Relation
@referenced-by src/stone/stone.ts — implemented-by — Stone 对象实例
@referenced-by src/persistence/frontmatter.ts — implemented-by — readme.md 格式
@referenced-by src/world/world.ts — implemented-by — World 本身也是对象
@referenced-by src/world/registry.ts — implemented-by — 对象注册与通讯录
@referenced-by .ooc/web/src/features/ObjectDetail.tsx — rendered-by
@referenced-by .ooc/web/src/features/IdentityTab.tsx — rendered-by
@referenced-by .ooc/web/src/features/DataTab.tsx — rendered-by
@referenced-by .ooc/web/src/components/Sidebar.tsx — rendered-by
@referenced-by .ooc/web/src/store/objects.ts — referenced-by
-->
...
<!--
@referenced-by src/types/object.ts — implemented-by — StoneData
@referenced-by src/types/flow.ts — implemented-by — FlowData, FlowStatus
@referenced-by src/stone/stone.ts — implemented-by — Stone 静态形态
@referenced-by src/flow/flow.ts — implemented-by — Flow 动态形态
@referenced-by src/flow/thinkloop.ts — implemented-by — ThinkLoop 执行引擎
@referenced-by src/world/session.ts — implemented-by — 同一任务中 Flow 复用
@referenced-by src/world/scheduler.ts — referenced-by — Flow 状态驱动调度
@referenced-by .ooc/web/src/features/FlowDetail.tsx — rendered-by
@referenced-by .ooc/web/src/features/EffectsTab.tsx — rendered-by
@referenced-by .ooc/web/src/store/flows.ts — referenced-by
-->
...
<!--
@referenced-by src/types/trait.ts — implemented-by — TraitDefinition, TraitWhen, TraitMethod
@referenced-by src/trait/loader.ts — implemented-by — 从文件系统加载 Trait
@referenced-by src/trait/activator.ts — implemented-by — Trait 激活逻辑
@referenced-by src/trait/registry.ts — implemented-by — 方法全量注册
@referenced-by src/context/builder.ts — implemented-by — Trait 内容注入 context
@referenced-by src/flow/thinkloop.ts — implemented-by — Trait 元编程 API
@referenced-by .ooc/web/src/features/TraitsTab.tsx — rendered-by
...
<!--
@referenced-by src/flow/thinkloop.ts — implemented-by — ThinkLoop 核心循环
@referenced-by src/flow/parser.ts — implemented-by — 程序提取与指令检测
@referenced-by src/executable/executor.ts — implemented-by — 沙箱执行引擎
@referenced-by src/executable/effects.ts — implemented-by — 副作用追踪
@referenced-by src/thinkable/client.ts — referenced-by — LLM 是思考引擎
...
<!--
@referenced-by src/types/context.ts — implemented-by — Context, ContextWindow, WindowConfig
@referenced-by src/context/builder.ts — implemented-by — buildContext 构建
@referenced-by src/context/formatter.ts — implemented-by — Context → LLM prompt
@referenced-by src/process/focus.ts — implemented-by — 结构化遗忘（栈进/栈出）
@referenced-by src/process/render.ts — implemented-by — focus 路径详细、其余摘要
@referenced-by src/types/process.ts — implemented-by — focus 光标驱动遗忘
@referenced-by src/trait/activator.ts — referenced-by — 激活决定 context 注入内容
@referenced-by src/flow/thinkloop.ts — implemented-by — 每轮构建 Context
-->
...
<!--
@referenced-by src/types/object.ts — implemented-by — Relation 类型
@referenced-by src/stone/stone.ts — implemented-by — addRelation
-->
...
<!--
@referenced-by src/persistence/reader.ts — implemented-by — readStone, readFlow, listObjects
@referenced-by src/persistence/writer.ts — implemented-by — writeStone, writeFlow
@referenced-by src/persistence/frontmatter.ts — implemented-by — readme.md 物理载体
@referenced-by src/stone/stone.ts — implemented-by — load/save/create
@referenced-by src/flow/flow.ts — implemented-by — Flow 持久化到 effects/
@referenced-by src/world/world.ts — implemented-by — .ooc/ 即 World 物理存在
@referenced-by src/world/registry.ts — referenced-by — 从 objects/ 扫描加载
@referenced-by src/trait/loader.ts — referenced-by — Trait 目录即 Trait 存在
-->

每个对象在文件系统中表现为一个目录：

```
.ooc/objects/{objectName}/
...
<!--
@referenced-by src/world/router.ts — implemented-by — talk/readShared/writeShared
@referenced-by src/world/scheduler.ts — implemented-by — 多 Flow 调度与错误传播
@referenced-by src/flow/flow.ts — implemented-by — deliverMessage 异步消息投递
@referenced-by src/flow/thinkloop.ts — implemented-by — 协作 API 注入
@referenced-by src/types/flow.ts — implemented-by — PendingMessage
@referenced-by src/executable/effects.ts — referenced-by — Effect 概念
@referenced-by src/world/session.ts — referenced-by — sub-flow 机制
@referenced-by .ooc/web/src/features/EffectsTab.tsx — rendered-by
...
<!--
@referenced-by src/types/process.ts — implemented-by — ProcessNode, Process, TodoItem
@referenced-by src/process/tree.ts — implemented-by — 节点 CRUD + appendAction
@referenced-by src/process/focus.ts — implemented-by — focus 光标移动规则
@referenced-by src/process/render.ts — implemented-by — 行为树文本渲染
@referenced-by src/flow/thinkloop.ts — implemented-by — 行为树 API 注入
@referenced-by src/context/builder.ts — referenced-by — 行为树渲染为 process 文本
...
<!--
@referenced-by src/types/flow.ts — implemented-by — Action, ActionType
@referenced-by src/flow/flow.ts — implemented-by — recordAction
@referenced-by src/flow/thinkloop.ts — implemented-by — 记录 thought/program 事件
@referenced-by src/process/tree.ts — implemented-by — appendAction 挂载到节点
@referenced-by src/types/process.ts — referenced-by — actions 字段
@referenced-by .ooc/web/src/features/ProcessView.tsx — rendered-by
-->
...
<!--
@referenced-by src/server/server.ts — referenced-by — API 提供对象数据给前端
@referenced-by src/server/events.ts — referenced-by — SSE 实时推送
@referenced-by .ooc/web/src/App.tsx — implemented-by — 前端整体布局
@referenced-by .ooc/web/src/features/ObjectDetail.tsx — implemented-by — 对象详情页
@referenced-by .ooc/web/src/features/ProcessView.tsx — implemented-by — 行为树可视化
@referenced-by .ooc/web/src/features/IdentityTab.tsx — implemented-by
@referenced-by .ooc/web/src/features/DataTab.tsx — implemented-by
@referenced-by .ooc/web/src/features/TraitsTab.tsx — implemented-by
@referenced-by .ooc/web/src/features/EffectsTab.tsx — implemented-by
@referenced-by .ooc/web/src/features/FlowDetail.tsx — implemented-by
@referenced-by .ooc/web/src/components/Sidebar.tsx — implemented-by
@referenced-by .ooc/web/src/hooks/useSSE.ts — referenced-by
...
<!--
@referenced-by src/types/trait.ts — referenced-by — Trait 是经验沉淀的载体
-->
...
<!--
@referenced-by src/flow/flow.ts — implemented-by — Flow 即忙碌的栈
@referenced-by src/process/focus.ts — implemented-by — focus 移动 = push/pop
@referenced-by src/trait/activator.ts — implemented-by — before 帧的 trait 激活
@referenced-by src/context/builder.ts — implemented-by — 作用域链 → Context
-->
