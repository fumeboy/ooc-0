...
**CRITICAL — 开始前 MUST 先用 Read 工具读取 [`../lark-shared/readme.md`](../lark-shared/readme.md)，其中包含认证、权限处理**。然后阅读 [`../lark-vc/readme.md`](../lark-vc/readme.md)，了解会议纪要相关操作。
...
阅读 [`../lark-doc/readme.md`](../lark-doc/readme.md) 学习云文档技能。
...
- [lark-shared](../lark-shared/readme.md) — 认证、权限（必读）
- [lark-vc](../lark-vc/readme.md) — `+search`、`+notes` 详细用法
- [lark-doc](../lark-doc/readme.md) — `+fetch`、`+create`、`+update` 详细用法
