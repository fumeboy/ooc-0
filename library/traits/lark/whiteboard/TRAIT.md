...
> 上传需要飞书认证。遇到认证或权限错误时，阅读 [`../lark-shared/readme.md`](../lark-shared/readme.md) 了解登录和权限处理。
...
关于飞书文档的创建，读取等更多操作，请参考 lark-doc skill [`../lark-doc/readme.md`](../lark-doc/readme.md)。
