...
- **L4-PR-ISSUE-FILE** — cross-scope evolve 越界开 PR-Issue 待评审；需 super flow worker 编排，**归 Tier B/e2e（skip）**。
...
| L4-PR-ISSUE-FILE | B-skip (`stories/L4_collaborable.stories.ts`) | cross-scope evolve 越界 → `flows/super/issues/issue-<id>.json` 出现 |
