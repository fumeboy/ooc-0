...
- **累计 P1 → P4 退潮信号**:visible 维度从设计承诺到机制层既成事实,4 个连续 phase 退潮闸门关上,web 端 bundle 累计 -20.7 KB / -2.2%,context-snapshot dead union 全部清退。剩余技术债:InlineTalkComposer/onUserReply 跨 5 文件 prop 链 + plan shape 漂移 + ObjectClientRenderer vs resolveWindowVisible 实现统一,留独立小 issue。
